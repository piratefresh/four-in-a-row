...
The player plays a sequence of hands against a rising target score. Each hand has Draft, Expand, and Finale phases. The player submits one word per phase, the three phase scores are added into a hand total, and the hand total is compared to the current target.
...
| State | Meaning |
|---|---|
| Active | The player is currently playing Draft, Expand, or Finale. |
...
A letter used during Draft can still be used during Expand and Finale.
...
- Solo run creation.
- Rising target curve.
- Draft, Expand, and Finale submissions.
...
- Draft reveals 4 tiles.
- Expand reveals 2 more tiles, for 6 total.
- Finale reveals the final tile, for 7 total.
- The player submits one word per phase.
