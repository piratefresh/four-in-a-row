...
export function TileShell({ children, className, disabled, isChoiceHighlight, isDragging, isNew, size, style, variant, ...divProps }: TileShellProps) {
  ...
  return (
    ...
    >
      ...
      {isNew && variant !== "empty" ? (
        <div className="pointer-events-none absolute -inset-y-6 -left-[95%] z-10 w-[70%] rotate-12 bg-[linear-gradient(90deg,transparent_0%,rgba(244,211,94,0)_18%,rgba(255,246,190,0.88)_46%,rgba(212,175,55,0.48)_56%,rgba(244,211,94,0)_82%,transparent_100%)] blur-[0.5px] mix-blend-screen motion-safe:animate-[tile-glint-sweep_0.58s_ease-out_both] [animation-delay:var(--tile-glint-delay,0s)]" />
      ) : null}
