...
export function RoomTable({
  ...
  return (
    <div
      className={
        variant === "mobile"
          ? "relative h-[min(210px,53vw)] w-[min(304px,calc(100vw-5.25rem))] rounded-[50%] border-[4px] border-[#3a2815] bg-[radial-gradient(ellipse_at_center,#1a4a35_0%,#0e3422_60%,#08291b_100%)] shadow-[inset_0_0_42px_rgba(0,0,0,0.62),0_10px_28px_rgba(0,0,0,0.42)] xs:h-[min(226px,51vw)] xs:w-[min(326px,calc(100vw-4.75rem))] sm:h-[min(242px,43vw)] sm:w-[min(356px,calc(100vw-3.5rem))]"
    ...
    >
      <div
        className={
          variant === "mobile"
            ? "absolute inset-[12px] rounded-[50%] border-2 border-gold/18"
            : "absolute inset-[14px] rounded-[50%] border border-gold/25"
        }
      />

      <div className="pointer-events-none absolute inset-2 rounded-[50%] bg-[conic-gradient(from_0deg,transparent_0deg,rgba(212,165,74,0.25)_30deg,transparent_60deg,transparent_360deg)] [mask:radial-gradient(circle,transparent_65%,#000_67%,#000_71%,transparent_73%)] motion-safe:animate-[felt-sweep_9s_linear_infinite]" />
